...
export interface backendInterface {
    ...
    adminRegister(roleText: string, name: string): Promise<RegistrationStatus>;
    assignCallerUserRole(user: Principal, role: UserRole): Promise<void>;
    deactivateUser(user: Principal): Promise<void>;
    driverRegister(name: string, busNumber: string): Promise<RegistrationStatus>;
    ...
    travellerRegister(name: string): Promise<RegistrationStatus>;
