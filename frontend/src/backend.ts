...
export class Backend implements backendInterface {
    ...
    async adminRegister(arg0: string, arg1: string): Promise<RegistrationStatus> {
        if (this.processError) {
            try {
                const result = await this.actor.adminRegister(arg0, arg1);
    ...
    async driverRegister(arg0: string, arg1: string): Promise<RegistrationStatus> {
        if (this.processError) {
            try {
                const result = await this.actor.driverRegister(arg0, arg1);
                return from_candid_RegistrationStatus_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async travellerRegister(arg0: string): Promise<RegistrationStatus> {
        if (this.processError) {
            try {
                const result = await this.actor.travellerRegister(arg0);
                return from_candid_RegistrationStatus_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
